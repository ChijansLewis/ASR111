...
class DataSpeech():
    ...
    def LoadDataList(self):
        ...
        '''
        # 设定选取哪一项作为要使用的数据集
        filename_wavlist_thchs30 = None
        filename_wavlist_stcmds = None
        filename_symbollist_thchs30 = None
        filename_symbollist_stcmds = None
        if self.type == 'train':
    ...
    def data_genetator(self, batch_size=32, audio_length=1600):
        ...
        while True:
            ...
            # print(X)
            yield [X, y, input_length, label_length], labels, [None]
